...
void Gekko::StateStorage::Init(u32 num_states, u32 state_size, bool limited)
{
	...
	// RE-AUDITED AT THE 2026-09 UPSTREAM SYNC (3945a61): the new spectator-state capture
	// (CaptureSpectatorState / PrepareSpectatorStates) and the ReplaySystem copy state_len bytes of a
	// saved entry — bytes the GAME wrote — never the ring's raw allocation.
	//
